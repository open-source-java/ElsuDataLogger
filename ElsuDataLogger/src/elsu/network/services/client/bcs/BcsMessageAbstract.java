...
/**
 * BcsMessageAbstract class provide support for the BcsMessage class. The
 ...
 */
public abstract class BcsMessageAbstract {
     ...
     * @see BcsMessage
     */
    public BcsMessageAbstract() {
        setMessageNumber();
    }

    public BcsMessageAbstract(String datetimeFormat, String delimiter,
            String terminator) {
        setMessageNumber();
    ...
    public synchronized static long getTotalMessageNumber() {
        return BcsMessageAbstract._totalMessageNumber;
    }
    ...
    private synchronized static long setTotalMessageNumber() {
        ...
        BcsMessageAbstract._totalMessageNumber++;
