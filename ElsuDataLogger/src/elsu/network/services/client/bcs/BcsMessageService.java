 ...
 * <p>
 * BcsMessageService is designed to accept incoming data from CS service,
...
public class BcsMessageService extends AbstractService implements IService {
     ...
     * @see ServiceAbstract
     */
    public BcsMessageService(ServiceFactory factory, String threadGroup,
    ...
    public synchronized void start() throws Exception {
        ...
        for (ServiceConfig subscriber : getServiceConfig().getSubscribers()) {
            ...
            if (subscriber.getStartupType() == ServiceStartupType.AUTOMATIC) {
                ...
                try {
                    ...
                    BcsMessageSubscriberService subcriberService
                            = new BcsMessageSubscriberService(getFactory(),
        ...
        for (ServiceConfig publisher : getServiceConfig().getPublishers()) {
            ...
            if (publisher.getStartupType() == ServiceStartupType.AUTOMATIC) {
                ...
                try {
                    // create the child service object
                    BcsMessagePublisherService publisherService
                            = new BcsMessagePublisherService(getFactory(),
                                    getServiceConfig().getServiceClass(), this,
                                    publisher);
