 ...
 * @see BcsMessageService
 * @see ServiceAbstract
 * @see ServiceProperties
 * @see ServiceRuntimeProperties
 */
public class BcsMessageSubscriberService extends AbstractService implements
        IService {
     ...
     * @param childConfig
     */
    public BcsMessageSubscriberService(ServiceFactory factory,
            String threadGroup, IService parentService,
            ServiceConfig childConfig) {
        // call the super class constructor
        super(factory, threadGroup,
                ((BcsMessageService) parentService).getServiceConfig());
     ...
     */
    @Override
    public synchronized BcsMessageService getParentService() {
        return (BcsMessageService) super.getParentService();
    }
                    ...
                    while (isRunning() && cConn.isActive()) {
                        ...
                        if ((line == null) || line.equals(
                            ...
                            try {
                                ...
                                BcsMessage message = new BcsMessage(
