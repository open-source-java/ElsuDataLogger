...
/**
 * BcsMessage class is used to store the message information. The information is
 * used by BcsMessageService, related subscribers and publishers, and storage
 * services to process user data.
 * <p>
 * This class is custom to BcsMessage and related objects, other classes can be
 ...
 */
public class BcsMessage extends BcsMessageAbstract {
     ...
     * @param payload
     */
    public BcsMessage(int siteId, int equipmentId, String payload) {
        // call super class constructor to populate message id
        super();
     ...
     * @param delimiter
     * @param terminator
     * @return <code>BcsMessage</code> object with all properties instantiated
     * from the parameters passed using custom parsing values (field delimiter,
     * date format, and record delimiter)
     */
    public static BcsMessage getBcsMessage(int siteId, int equipmentId,
            String payload,
            String datetimeFormat, String delimiter, String terminator) {
        BcsMessage bcsMessage = new BcsMessage(siteId, equipmentId, payload,
     ...
     * date format, and record delimiter)
     */
    public static BcsMessage getBcsMessage(String message) {
